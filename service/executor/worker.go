...
func (w *Worker) executeAndPostProcess(ctx context.Context, timerID uint, unix int64) error {
	...
	return w.postProcess(ctx, resp, err, timerID, unix)
}
...
func (w *Worker) postProcess(ctx context.Context, resp map[string]interface{}, execErr error, timerID uint, unix int64) error {
